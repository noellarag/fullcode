...
public class Constants {
    ...
    public static final double kWheelRadiusMeters = 3; //3in
    

    public static final double kDriveTickToMeters = (1.0/2048*2*Units.inchesToMeters(kWheelRadiusMeters ) *Math.PI);
