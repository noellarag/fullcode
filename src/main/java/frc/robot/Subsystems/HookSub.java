...
public class HookSub extends SubsystemBase {
  private final CANSparkMax m_hookMotor1 = new CANSparkMax(10, MotorType.kBrushed);
  private final CANSparkMax m_hookMotor2 = new CANSparkMax(9, MotorType.kBrushed);
